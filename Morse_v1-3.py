...
- Menu function to loop in if the choice in try_again function answer is 'n' (no)
...
def menu():                                                 # fucntion to display the main menu
...
def try_again():                                            # function to choose if a menu's item might run again
    print()
    while True:
        try:
            again = input('Do it again ? y/n...')
            if again == 'y' or again == 'Y':
                return None                                 # go back in the function executed
            if again == 'n' or again == 'N':
                menu()                                      # go back in the main menu
            else:
                print("\n--> Your choice is invalid, try again...\n")
                continue                                    # loop if the answer  is invalid
...
def code_ltr():                                             # function to code in Morse a letter given by the user
    print()
    generique('Code a letter/number')                       # print the title of this section
    while True:
        try:
            ltr = input("\n Input a letter '(a to z)' or a number '(1 to 0)'")  # input of a character
            if ltr in morse_code:
                code_list = morse_code.get(ltr)             # get the list wich is the 'value' of the dic for the 'ltr' key
    
                for code in code_list:                      # for the number of item in the list
                    print(code)
                ...
                print("\n--> Your choice is invalid, try again...\n")  # loop if the choice is invalid
                continue
        except ValueError:                                  # error in the choice
                print("\n--> Your choice is invalid, try again...\n")
                break
        try_again()                                         # execute the try_again function to know what the user want to do

 
def impulse_ltr():                                         # function to code in Morse a letter impulsed by the user with the button (to be developped)
    print()
    generique('Impulse a letter in Morse')
    print()
...
def impulse_wrd():                                         # function to code in Morse a word impulsed by the user with the button (to be developped)
    print()
    generique('Impulse a word in Morse')
    print()
...
def impulse_stc():                                         # function to code in Morse a sentence impulsed by the user with the button (to be developped)
    print()
    generique('Impulse a sentence in Morse')
    print()
...
def learn_mode():                                         # function to learn Morse coding/decoding
    print()
    generique('Learn the Morse code')
    print()
...
if __name__ == '__main__':                                  # program main entrance
    ...
    menu()                                                  # execute the menu function for the main menu of the program
