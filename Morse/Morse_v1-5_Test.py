...
Future ehancements :
 ...
 - Coding and decoding words  --> in dev with the 'code()' function
 - Coding and decoding sentences --> in dev with the 'code()' function
...
# 'code(to_code)' function is on developpement    
def code(to_code):                                          # function to code in Morse a letter, a word or a sentence given by the user (in dev)
                                                            # receive a list as argument to be coded
    while True:
        try:
