 ...
 * V 1.0 :
 ...
 - Developpement of the keyboard or the mouse action to enter Morse Code.
...
Future ehancements :
 ...
 - Keyboard/Mouse impulsions decoding.
...
#def point():                                             # Function to play the 'point' Morse's Code
#    pygame.mixer.music.load("/media/jma/EDEA-20AC/Programmation_Python/Projet_Desktop_Morse/Doc_Utils/Morse_point.wav")   # Load the 'point' sound from path/fichier.wav
#    pygame.mixer.music.play()                            # Play the sound
#    time.sleep (0.23)                                    # Wait 0.23 second - this time is needed to reflect the reality of Morse Code

#def trait():                                             # Function to play the 'line' Morse's Code
#        pygame.mixer.music.load("/media/jma/EDEA-20AC/Programmation_Python/Projet_Desktop_Morse/Doc_Utils/Morse_trait.wav") # Load the 'line' sound
#        pygame.mixer.music.play()
#        time.sleep(0.42)                                 # Wait 0.42 second - this time is needed to reflect the reality of Morse Code

        
def code(ltr):                                           # function to code a character from a single letter, a word or a sentence
    code_list = morse_code.get(ltr)                      # extract the list of codes (values of 1 or 2) wich is value of the dictionnary key
    print(ltr)
