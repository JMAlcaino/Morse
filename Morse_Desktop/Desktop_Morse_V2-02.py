...
############################################################################################################
 ...
 Filename     : Morse_desktop_v2-02.py                                                                              
 ...
 modification : 2024/11/01                                                                             
 version      : V 2.02   Algorythms test's version for developpement. Work in progress.
...
Future ehancements :  '-' = to be done    '/' = in developpement    'X' = finished
 ...
 - Play a sound when key/mouse is pressed to input something to decode or in learning mode
...
def code(character):                                         # Function to code a character from a single letter, a word or a sentence
    tmr = 0                                                  # Timer to be incremented to get the coding duration
